...
class K8SV1API(API):
    ...
    async def set_pool_taints(
        ...
        *,
        ...
        ::
            ...
            result = await api.set_pool_taints(
                pool_id="example",
            )
        """
    ...
    async def set_pool_startup_taints(
        self,
        *,
        pool_id: str,
        region: Optional[ScwRegion] = None,
        ...
        ::
            ...
            result = await api.set_pool_startup_taints(
                pool_id="example",
            )
        """
    ...
    async def set_pool_labels(
        ...
        *,
        ...
        ::
            ...
            result = await api.set_pool_labels(
                pool_id="example",
            )
        """
